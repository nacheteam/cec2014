...
static const char __pyx_k_cec2014_pyx_Define_cec14_que_ll[] = "\ncec2014.pyx\n\nDefine cec14 que llama a la funci\303\263n objetivo en C++\n";
  ...
  __Pyx_RefNannySetupContext("cec14 (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_func_num)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cec14", 1, 2, 2, 1); __PYX_ERR(0, 16, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "cec14") < 0)) __PYX_ERR(0, 16, __pyx_L3_error)
      }
    ...
    __pyx_v_func_num = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_func_num == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("cec14", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 16, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_7cec2014_cec14(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input, int __pyx_v_func_num) {
  ...
  __pyx_pybuffernd_input.rcbuffer = &__pyx_pybuffer_input;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_input.rcbuffer->pybuffer, (PyObject*)__pyx_v_input, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 16, __pyx_L1_error)
  }
 ...
 */
  ...
  __pyx_t_1 = 0;
  __pyx_t_2 = PyFloat_FromDouble(cec14_test_func_rev((&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_input.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_input.diminfo[0].strides))), (__pyx_v_input->dimensions[0]), __pyx_v_func_num)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 17, __pyx_L1_error)
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "cec2014",
    __pyx_k_cec2014_pyx_Define_cec14_que_ll, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
 ...
 *   return cec14_test_func_rev(&input[0], input.shape[0], func_num)
 */
  __pyx_tuple__10 = PyTuple_Pack(2, __pyx_n_s_input, __pyx_n_s_func_num); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(2, 0, 2, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cec2014_pyx, __pyx_n_s_cec14, 16, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cec2014", __pyx_methods, __pyx_k_cec2014_pyx_Define_cec14_que_ll, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
 ...
 *   return cec14_test_func_rev(&input[0], input.shape[0], func_num)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7cec2014_1cec14, NULL, __pyx_n_s_cec2014); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_cec14, __pyx_t_1) < 0) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
